...
class Server_list_parser_vpnjantit(Server_list_parser_base):
    ...
    def parse(self) -> dict:
        ...
        server_url_list = [self.server_provider_url+x.xpath('div/a[1]/@href')[0] for x in region_card_xpath_list] # ['https://www.vpnjantit.com/create-free-account?server=bg2&type=SSH', ..
